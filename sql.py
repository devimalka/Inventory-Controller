...
class DBConnector():
    ...
    def init(self):
        ...
        self.execute('CREATE TABLE IF NOT EXISTS componentdata(componentdataID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,serial TEXT NOT NULL,description TEXT NOT NULL,in_date TEXT NOT NULL,componentID INTEGER NOT NULL,computer_ID INTEGER NULL,FOREIGN KEY(componentID) REFERENCES component(componentID),UNIQUE(serial));')
        ...
        self.execute(component_Data)
        self.execute(computer)
        self.execute(component)
        self.execute(computer_type)
